      ...
      const productoHTML = `
            <div class="card text-center" style="width: 100%; height: 100%;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text" style="margin-top: 4rem; font-size: 1rem;">Precio: $${product.precio}</p>
                    <p class="card-text" style="margin-top: 4rem; font-size: 1rem;">Calificación: ${product.calificacion}</p>
                </div>
            </div>
        `;
